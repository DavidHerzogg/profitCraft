...
export const CapitalChart = ({ data, startCapital = 0 }) => {
  ...
  }, [filteredRawData, startCapital, parseProfit, selectedRange, now]);
  ...
  const chartData = useMemo(() => ({
    datasets: [{ data: transformedData, borderColor: '#dbaf58', backgroundColor: 'rgba(219,175,88,0.2)', fill: true, pointRadius: width > 1024 ? 4 : 2 }]
  }), [transformedData, width]);

  // Redesigned controls: segmented pills
